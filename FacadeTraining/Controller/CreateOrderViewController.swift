...
class CreateOrderViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
  ...
  func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
    ...
    //let tax = taxCalculation.calculateTaxForSubtotal(subtotal, andState: selectedState)
    let totalAmount = subtotal + tax
    totalAmountLabel.text = String.formattedCurrencyStringFromCents(totalAmount)
  }
